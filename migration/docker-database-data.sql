...
create table products(id serial primary key, nome varchar, descricao varchar, quantidade varchar, seller varchar);
...
INSERT INTO products(nome, descricao, quantidade) VALUES('Produto Extravagante', 'Com um material de extrema extravagancia, este produto é extravagante.', '23', '2');
